...
class ArduinoStreamWidget(object):
    def __init__(self):
        ...
        self.serS = serial.Serial('/dev/ttyUSB0', 500000)
        self.serM = serial.Serial('/dev/ttyUSB1', 500000)
...
class VideoStreamWidget(object):
    ...
    def get_ball_command(self):
        if self.X_ball ==0 and self.Y_ball == 0 :
            ...
            return 'w'
        elif self.X_ball < 286 - 10:
            return 'q'
        elif self.X_ball > 300 + 10:
            return 'e'
        else:
             return 'o'
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            print('x : ', x, '\t','y : ', y)
            print('motor command : ',video_stream_widget.get_ball_command())
